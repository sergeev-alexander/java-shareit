...
public interface BookingService {
    ...
    Collection<OutgoingBookingDto> getAllUserBookings(Long userId, BookingState bookingState);

    Collection<OutgoingBookingDto> getAllOwnerItemBookings(Long ownerId, BookingState bookingState);
